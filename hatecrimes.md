...
![](hatecrimes_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-4-1.png)<!-- -->

```r
p + scale_fill_gradientn(colours = colorRampPalette(brewer.pal(11,"RdYlBu"))(11)) # red to blue  
```

![](hatecrimes_files/figure-html/unnamed-chunk-4-2.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-4-3.png)<!-- -->

```r
p + aes(y = 300) # make it warming stripes
```

![](hatecrimes_files/figure-html/unnamed-chunk-4-4.png)<!-- -->

```r
p + aes(x = as.factor(Monthyear), y = 300) # to avoid missing stripes, make yearmonth a factor 
```

![](hatecrimes_files/figure-html/unnamed-chunk-4-5.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-4-6.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-5-2.png)<!-- -->

```r
pnj + aes(x = as.factor(Monthyear), y = 300) # to avoid missing stripes, make yearmonth a factor 
```

![](hatecrimes_files/figure-html/unnamed-chunk-5-3.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-5-4.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-6-2.png)<!-- -->

```r
p + aes(y = 300) # make it warming stripes
```

![](hatecrimes_files/figure-html/unnamed-chunk-6-3.png)<!-- -->

```r
p + aes(x = as.factor(Month), y = 300) # to avoid missing stripes, make month a factor 
```

![](hatecrimes_files/figure-html/unnamed-chunk-6-4.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-6-5.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-7-2.png)<!-- -->

```r
pnj + aes(x = as.factor(Month), y = 300) # to avoid missing stripes, make month a factor 
```

![](hatecrimes_files/figure-html/unnamed-chunk-7-3.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-7-4.png)<!-- -->
...
![](hatecrimes_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

```r
pnj + coord_polar(theta = "x") 
```

![](hatecrimes_files/figure-html/unnamed-chunk-8-2.png)<!-- -->
